...
class SoundSilDS(nn.Module):

    def __init__(self, img_channel=2, out_channel=3, width=16, middle_blk_num=1, enc_blk_nums=[], dec_blk_nums=[], GCE_CONVS_nums=[]):
        super().__init__()
